...
export default function Footer() {
  ...
  return (
    <footer className="marble-bg bg-[#FBF8F2] border-t border-[#123524]/12 text-[#4A574C]">
      <div className="max-w-site mx-auto px-6 lg:px-10 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2 text-sm">
              <a href="tel:02030267906" className="flex items-center gap-2 hover:text-[#123524] transition-colors">
                <span className="text-[#123524]/40 text-xs">T</span> 020 3026 7906
              </a>
              <a href="mailto:hello@prosaria.co.uk" className="flex items-center gap-2 hover:text-[#123524] transition-colors">
                <span className="text-[#123524]/40 text-xs">E</span> hello@prosaria.co.uk
              </a>
              <p className="flex items-start gap-2 text-[#6E7B6F]">
                <span className="text-[#123524]/40 text-xs mt-0.5">A</span>
          ...
          <div>
            <p className="eyebrow text-[#E8650D]/70 mb-5">Get in touch</p>
            <nav className="flex flex-col gap-3">
              {[
            ...
            <div className="mt-8 space-y-2">
              <p className="eyebrow text-[#E8650D]/70 mb-3">Connect</p>
              <a href="https://www.linkedin.com/in/mrpowell22/" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-[#123524] transition-colors block">Nathan on LinkedIn</a>
              <a href="https://www.linkedin.com/company/prosaria-partners" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-[#123524] transition-colors block">Prosaria on LinkedIn</a>
            </div>
          </div>

        </div>

        <div className="border-t border-[#123524]/12 pt-8 flex flex-col sm:flex-row justify-between gap-4 text-xs text-[#4A574C]">
          ...
          <Link href="/privacy" className="hover:text-[#4A574C] transition-colors">Privacy policy</Link>
        </div>
      </div>
    </footer>
  )
