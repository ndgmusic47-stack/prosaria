...
const questions = [
  ...
  },
  {
    ...
    options: [
      { label:'Yes, it works well',             value:'yes-good' },
    ...
    return (
      <div className="min-h-screen bg-[#050d1a] pt-32 pb-24">
        <div className="max-w-[680px] mx-auto px-6">
          <Link href="/work#capital" className="eyebrow text-[#475569] hover:text-blue-400 transition-colors mb-8 block">
          ...
          <div className="bg-[#0a1628] border border-blue-500/10 p-10 mb-8">
            {releasable ? (
              <>
                <p className="text-body-sm text-[#94a3b8] mb-2">Estimated monthly cash you could release</p>
                ...
                <p className="text-body-sm text-[#475569]">
                  Based on your payment terms and turnover. This is an estimate. The actual figure depends on your debtor book and the facility structure.
                </p>
              </>
            ) : (
              <>
                <p className="font-serif text-display-sm text-[#f0f4ff] mb-3">
                  Your payment terms are short. Invoice finance may not be the main tool here.
                </p>
                <p className="text-body-sm text-[#94a3b8]">
                  We will take a look and come back with what might be more useful for your situation.
                </p>
              </>
            )}
          </div>
          ...
          <div className="space-y-4 mb-10">
            {canImprove && (
              <div className="flex gap-4 p-6 bg-[#0a1628] border border-blue-500/8">
                ...
                <p className="text-body-sm text-[#94a3b8]">You have an existing facility but think you could do better. In most cases you can. The market has changed and many businesses are overpaying.</p>
              </div>
            )}
            {noFacility && (
              <div className="flex gap-4 p-6 bg-[#0a1628] border border-blue-500/8">
                <span className="text-blue-400 font-serif text-lg mt-0.5">—</span>
                <p className="text-body-sm text-[#94a3b8]">You do not have a facility yet. Depending on your debtor quality there are lenders who would actively want to work with a business in your sector and size range.</p>
              </div>
            )}
            {releasable && (
              <div className="flex gap-4 p-6 bg-[#0a1628] border border-blue-500/8">
                <span className="text-blue-400 font-serif text-lg mt-0.5">—</span>
                <p className="text-body-sm text-[#94a3b8]">On 60 or 90 day terms, roughly 80% of your outstanding invoices could be available to draw against immediately. The cost of the facility is typically a fraction of what that tied-up cash costs you.</p>
              </div>
            )}
          </div>

          <p className="text-label text-[#334155] mb-6">Indicative estimate only. Not financial advice.</p>
          ...
          <div className="bg-[#0a1628] border border-blue-500/10 p-8">
            ...
            <p className="text-body-sm text-[#94a3b8] mb-6">We will follow up within one business day.</p>
    ...
    <div className="min-h-screen bg-[#050d1a] pt-32 pb-24">
      <div className="max-w-[680px] mx-auto px-6">
        ...
        <p className="text-body-sm text-[#94a3b8] mb-10">
          4 questions. Instant cash estimate. We follow up on every submission personally.
        </p>
          ...
          {q.type === 'contact' && (
            <div className="space-y-5">
              ...
              <p className="text-label text-[#334155]">
                Your estimate shows immediately. We also receive it and follow up within one business day.
              </p>
