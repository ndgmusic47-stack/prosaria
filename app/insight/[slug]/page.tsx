      ...
      <section className="bg-[#F7F3EC] pt-40 pb-20 lg:pt-52 lg:pb-24 relative overflow-hidden">
        <div className="relative max-w-site mx-auto px-6 lg:px-10">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8">
            <span className={`text-label border px-2.5 py-1 ${categoryColours[post.category] || 'text-[#4A574C] border-[#D8CFC0]'}`}>
              {post.category}
            </span>
          </div>
          <h1 className="font-serif text-display-lg text-[#0F2E1D] leading-tight max-w-[28ch]">
            {post.title}
          </h1>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#F7F3EC]">
        <div className="max-w-site mx-auto px-6 lg:px-10">
          <div className="max-w-[680px]">
            <div
              className="text-[#4A574C] leading-relaxed"
          ...
          <div className="max-w-[680px] mt-16 pt-12 border-t border-[#123524]/12">
            <p className="text-label text-[#8A948A] mb-1 uppercase tracking-widest">Published by</p>
            <p className="text-body-sm text-[#4A574C]">Prosaria — <a href="https://www.linkedin.com/company/prosaria-partners" className="text-[#123524] hover:text-[#1B4D33] transition-colors" target="_blank" rel="noopener noreferrer">LinkedIn</a></p>
          </div>
        </div>
      </section>
